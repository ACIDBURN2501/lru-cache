# Contributing to lru-cache

lru-cache is a small C library providing a static-memory, deterministic
Least Recently Used (LRU) cache. It is designed to be safe to drop into
